...
function AnimatedCounter({ value, suffix = '', label }) {
    ...
    return (
        <div ref={ref}>
            ...
            <div className="font-mono text-[9px] sm:text-[10px] tracking-[0.05em] sm:tracking-[0.2em] leading-tight uppercase text-text-tertiary mt-2">
                {label}
            </div>
        </div>
    )
    ...
    return (
        <section id="about" className="relative py-28 sm:py-36">
            <div className="content-container">
                ...
                >
                    <div className="py-6 sm:py-8 pr-2 sm:pr-6 border-r border-white/[0.07]">
                        <AnimatedCounter value={9} suffix="+" label="Projects Built" />
                    </div>
                    <div className="py-6 sm:py-8 px-2 sm:px-10 border-r border-white/[0.07]">
                        <AnimatedCounter value={200} suffix="+" label="DSA Problems" />
                    </div>
                    <div className="py-6 sm:py-8 pl-2 sm:pl-10">
